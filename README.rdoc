...
Tested on:
  ...
  ruby virtual machine: 
    ...
    ruby 1.9.3 - Os, Linux: Ubuntu, Debian wheezy
    ruby 2.0.0 - Linux: Ubuntu, Debian wheezy
...
Tests:
  !!!For some reason I can't receive emails when testing on mac !!!
...
Emailing:
  ...
  !!!IMPORTANT!!!
  For testing purpose all emails will go to tmp/mails/*, emails are nice formated and decoded.
  Everything is set!!!
