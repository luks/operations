...
describe BookingsController do
  ...
  let(:valid_attributes) { { "from" => "2014-04-06 21:11:20" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved booking as @booking" do
        ...
        post :create, {:booking => { "from" => "invalid value" }}, valid_session
        assigns(:booking).should be_a_new(Booking)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested booking" do
        ...
        Booking.any_instance.should_receive(:update_attributes).with({ "from" => "2014-04-06 21:11:20" })
        put :update, {:id => booking.to_param, :booking => { "from" => "2014-04-06 21:11:20" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the booking as @booking" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Booking.any_instance.stub(:save).and_return(false)
        put :update, {:id => booking.to_param, :booking => { "from" => "invalid value" }}, valid_session
        assigns(:booking).should eq(booking)
      end
