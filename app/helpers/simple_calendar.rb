module SimpleCalendar
  module ViewHelpers
      ...
      content_tag(:table, :class => options[:class]) do
        ...
        tags << content_tag(:tbody, :'data-month'=>selected_month.month, :'data-year'=>selected_month.year) do
          ...
          month.collect do |week|
            week_header()
            ['day', 'night'].each do |watch|
            tr << content_tag(:tr, :class => (week.include?(Date.today) ? "current-week week" : "week")) do
              ...
              week.collect do |date|
                ...
                cur_events = day_events(date, events, watch)
    ...
    def day_events(date, events, watch)
        events.select do |e|
          e.start_time.to_date == date and e.shift.upcase == watch.upcase
